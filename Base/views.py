...
# def home(request):
#     return HttpResponse("Hello Onkarr Here")
...
def contact(request):
    if request.method=="POST":
        ...
        if len(name)>1 and len(name)<30:
            ...
            messages.error(request,'Length of name sholud be greater than 2 and less than 30 words')
            return render(request,'home.html')
        ...
        ins.save()
        messages.success(request,'Thankyou for connecting me || Your message have been saved')
